...
### Передача маршрутов EIGRP в OSPF и обратно
* router ospf *1*
* redistribute eigrp *100* subnets — все подсети, расположенные в ospf
* router eigrp *100*
* redistribute ospf *1* metric 1000 35 255 1 1500 — данные метрики являются рекомендуемыми
